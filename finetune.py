...
def eval_linear(args):
    ...
    dataset_val = PatchLabelDataset(os.path.join(args.data_path, "test"), fold='val', transform=val_transform)
    ...
    dataset_train = PatchLabelDataset(os.path.join(args.data_path, "train"), fold='train', transform=train_transform)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default="./dino_out/finetune/", help='Path to save logs and checkpoints')
